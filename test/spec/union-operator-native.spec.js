describe( 'Union operator', () => {
    ...
    it( 'combines a namespace and attribute on the same element', () => {
        const result = documentEvaluate( "id('nss25')/namespace::*", doc, null, win.XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null );
    ...
    it( 'combines two namespaces on the same element', () => {
        const result = documentEvaluate( "id('nss40')/namespace::*", doc, null, win.XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null ); //
